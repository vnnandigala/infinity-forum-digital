    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-slate-100 rounded-2xl p-8 mt-8 shadow-xl">
            <h3 className="text-2xl font-bold text-slate-900 mb-6">Terms and Conditions</h3>
            <div className="text-slate-700 space-y-4 text-sm leading-relaxed max-h-96 overflow-y-auto">
              <div>
                <h4 className="font-bold text-slate-900 mb-2">Infinity Forum Membership: Terms and Conditions</h4>
                <p className="mb-4">Welcome to Infinity Forum!</p>
                <p className="mb-4">By submitting your membership application, you agree to the following Terms and Conditions of Infinity Forum. These terms outline the rules and expectations for joining and participating in the Infinity Forum community.</p>
              </div>
              
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">1. Membership Eligibility</h5>
                <p className="mb-2">To be eligible for membership in Infinity Forum, you must meet the following criteria:</p>
              ...
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">2. Membership Benefits</h5>
                <p className="mb-2">As a member of Infinity Forum, you will have access to the following:</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>Curated Content: Exclusive resources, podcasts, and articles.</li>
                  <li>Networking Opportunities: Connect with like-minded professionals, entrepreneurs, and investors.</li>
                  <li>Mentorship and Guidance: Access to mentorship from industry leaders and peer-to-peer support.</li>
                  <li>Events and Discussions: Invitations to exclusive in-person and virtual events focused on intellectual growth, wealth creation, and social impact.</li>
                  <li>Investment Opportunities: Participate in vetted investment opportunities within the forum's community.</li>
                </ul>
              </div>

              <div>
                <h5 className="font-semibold text-slate-900 mb-2">3. Code of Conduct</h5>
                <p className="mb-2">By joining Infinity Forum, you agree to uphold the following principles:</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
                  <li>Respectful Engagement: Treat all members with respect and professionalism.</li>
                  <li>Confidentiality: Maintain the confidentiality of any sensitive or proprietary information shared within the forum.</li>
                  <li>Constructive Participation: Engage in discussions and activities in a manner that fosters learning, growth, and collaboration.</li>
                  <li>Mentorship and Giving Back: Contribute to the community by offering mentorship or support to other members, especially underprivileged entrepreneurs.</li>
                </ul>
              </div>

              <div>
                <h5 className="font-semibold text-slate-900 mb-2">4. Gender Equality Initiative</h5>
              ...
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">5. Membership Dues</h5>
                <p className="mb-2">Annual Membership Fee: The annual membership fee for Infinity Forum is $250.</p>
                <p>The membership fee grants access to all exclusive content, events, and mentorship opportunities within the community.</p>
              </div>

              <div>
                <h5 className="font-semibold text-slate-900 mb-2">6. Termination of Membership</h5>
                <p className="mb-2">Infinity Forum reserves the right to suspend or terminate the membership of any individual who:</p>
                <ul className="list-disc list-inside ml-4 space-y-1">
              ...
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">7. Intellectual Property</h5>
              ...
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">8. Liability and Indemnity</h5>
              ...
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">9. Changes to Terms and Conditions</h5>
              ...
              <div>
                <h5 className="font-semibold text-slate-900 mb-2">10. Governing Law</h5>
