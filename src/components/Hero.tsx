    ...
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 w-full">
        <div className="max-w-4xl">
          ...
          {/* Description */}
          <p className="text-xl text-slate-300 max-w-3xl mb-8 leading-relaxed animate-fade-in animate-delay-400">
          ...
          {/* Video Section */}
          <div className="mb-12 animate-fade-in animate-delay-500">
            <div className="relative w-full max-w-2xl rounded-2xl overflow-hidden shadow-2xl border-2 border-amber-500/30">
          ...
          <div className="mb-8 animate-fade-in animate-delay-600">
            <div className="inline-flex items-center bg-amber-500/20 backdrop-blur-sm border border-amber-500/30 rounded-full px-6 py-3 text-amber-300">
              ...
              <span className="text-sm font-semibold">Next Event: Investments - Dec 7th, 2-5 PM</span>
            </div>
          </div>
